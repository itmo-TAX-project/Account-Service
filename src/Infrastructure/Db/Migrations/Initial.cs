...
public class Initial : Migration
{
    ...
    {
        Execute.Sql(@"CREATE TYPE account_roles AS ENUM ('passenger', 'driver', 'admin');");
        ...
        Create.Table("accounts")
            ...
            .WithColumn("account_role").AsCustom("account_roles").NotNullable()
    ...
    public override void Down()
    {
        ...
        Execute.Sql("DROP TYPE IF EXISTS account_roles;");
    }
}